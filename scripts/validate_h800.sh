...
python -c 'import torch; print("torch:", torch.__version__, "CUDA:", torch.version.cuda); assert torch.cuda.is_available(); print(torch.cuda.get_device_name()); assert torch.cuda.get_device_capability()[0] == 9, "Hopper GPU required"'
nvcc --version
